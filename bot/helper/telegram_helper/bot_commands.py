...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = f'ngoco{CMD_INDEX}'
        self.UnzipMirrorCommand = f'unzipmirror{CMD_INDEX}'
        self.ZipMirrorCommand = f'ziptor{CMD_INDEX}'
        self.CancelMirror = f'gagal{CMD_INDEX}'
